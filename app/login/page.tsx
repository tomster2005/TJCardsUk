  ...
  return (
    <div className="mx-auto max-w-lg">
      <div className="rounded-3xl border border-white/10 bg-zinc-950/80 p-8">
        ...
        <p className="mt-2 text-sm text-zinc-400">Sign in with email and password (demo only).</p>
        ...
        <form onSubmit={submit} className="mt-6 grid gap-4">
          ...
          <div className="mt-4 flex items-center gap-2">
            ...
            <button type="button" onClick={() => router.push("/register")} className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-zinc-200">
              Create account
            </button>
          </div>
        </form>
