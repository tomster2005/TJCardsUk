    ...
    <Layout>
      <section className="relative overflow-hidden rounded-[2rem] p-10 shadow-[0_20px_48px_rgba(15,23,42,0.09)]">
        ...
        <div className="space-y-4">
          <p className="relative text-xs uppercase tracking-[0.34em] text-amber-700">Marketplace</p>
          <h1 className="relative text-4xl font-semibold text-zinc-900 sm:text-5xl">Buy missing cards with confidence</h1>
          <p className="relative max-w-2xl text-zinc-600">
            A placeholder for the marketplace where collectors can find cards that help complete their collections.
          </p>
        </div>
