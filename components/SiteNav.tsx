...
export function SiteNav() {
  ...
  const secondaryNav = [
    ...
    ...(user ? [{ href: "/admin", label: "Admin", desc: "Manage the vault" }] : []),
  ];
  ...
  const linkClass = (active: boolean) =>
    `nav-link relative inline-flex items-center gap-1.5 rounded-full px-3.5 py-2 text-[13px] font-medium transition-all duration-250 ${
      active
        ? "is-active text-[#f5d97a] bg-[rgba(200,155,60,0.1)] border border-[rgba(200,155,60,0.2)]"
        : "text-[rgba(232,230,225,0.55)] hover:text-[rgba(232,230,225,0.9)] hover:bg-[rgba(255,255,255,0.05)] border border-transparent"
    }`;
  ...
  return (
    <header
      className={`sticky top-0 z-40 transition-all duration-400 ${
        scrolled
          ? "bg-[rgba(13,13,15,0.92)] backdrop-blur-2xl border-b border-[rgba(255,255,255,0.06)] shadow-[0_1px_0_rgba(200,155,60,0.08),0_4px_24px_rgba(0,0,0,0.4)]"
          : "bg-[rgba(13,13,15,0.6)] backdrop-blur-xl border-b border-[rgba(255,255,255,0.04)]"
      }`}
    >
      <div className="mx-auto flex max-w-[116rem] items-center justify-between px-4 py-3 sm:px-6 lg:px-10 xl:px-14">
        ...
        <Link href="/" className="group flex items-center gap-3">
          <span className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#f5d97a] via-[#c89b3c] to-[#a07828] text-[13px] font-black text-[#0d0d0f] shadow-[0_4px_20px_rgba(200,155,60,0.5)] animate-soft-pulse transition-all duration-300 group-hover:shadow-[0_6px_28px_rgba(200,155,60,0.7)]">
            C
          </span>
          <div className="flex flex-col leading-none">
            <span className="text-[14px] font-bold uppercase tracking-[0.28em] text-[#e8e6e1]">Collectra</span>
        ...
        <nav className="hidden items-center gap-0.5 md:flex">
          ...
          <div className="mx-2 h-4 w-px bg-[rgba(255,255,255,0.08)]" />

          {/* Cart */}
          <button
            type="button"
            onClick={openCart}
            className="nav-link relative inline-flex items-center gap-1.5 rounded-full border border-transparent px-3.5 py-2 text-[13px] font-medium text-[rgba(232,230,225,0.55)] transition-all duration-250 hover:border-[rgba(255,255,255,0.08)] hover:bg-[rgba(255,255,255,0.05)] hover:text-[rgba(232,230,225,0.9)]"
          >
          ...
          <div className="relative ml-1" ref={menuRef}>
            <button
              ...
              className={`inline-flex items-center gap-2 rounded-full border px-3.5 py-2 text-[13px] font-medium transition-all duration-250 ${
                menuOpen
                  ? "border-[rgba(200,155,60,0.3)] bg-[rgba(200,155,60,0.08)] text-[#f5d97a]"
                  : "border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] text-[rgba(232,230,225,0.6)] hover:border-[rgba(255,255,255,0.12)] hover:bg-[rgba(255,255,255,0.06)] hover:text-[rgba(232,230,225,0.9)]"
              }`}
            >
            ...
            {menuOpen && (
              <div className="animate-nav-drop absolute right-0 top-full mt-2 w-60 overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.08)] bg-[rgba(20,20,24,0.97)] shadow-[0_24px_60px_rgba(0,0,0,0.6)] backdrop-blur-2xl">
                <div className="p-1.5">
                  {secondaryNav.map((item) => (
                    <Link
                      ...
                      className={`flex flex-col rounded-xl px-3 py-2.5 transition-colors ${
                        isActive(item.href)
                          ? "bg-[rgba(200,155,60,0.1)] text-[#f5d97a]"
                          : "text-[rgba(232,230,225,0.7)] hover:bg-[rgba(255,255,255,0.05)] hover:text-[rgba(232,230,225,0.95)]"
                      }`}
                    >
                      <span className="text-[13px] font-semibold">{item.label}</span>
                      <span className="text-[11px] opacity-50">{item.desc}</span>
                    </Link>
                  ))}
                </div>
                <div className="border-t border-[rgba(255,255,255,0.06)] p-1.5">
                  {user ? (
                    <button
                      ...
                      className="flex w-full items-center gap-2 rounded-xl px-3 py-2.5 text-[13px] font-medium text-[rgba(239,68,68,0.8)] transition-colors hover:bg-[rgba(239,68,68,0.08)] hover:text-[#f87171]"
                    >
                      Sign out
                    </button>
                  ) : (
                    <Link
                      href="/login"
                      onClick={() => setMenuOpen(false)}
                      className="flex items-center gap-2 rounded-xl px-3 py-2.5 text-[13px] font-medium text-[rgba(232,230,225,0.6)] transition-colors hover:bg-[rgba(255,255,255,0.05)] hover:text-[rgba(232,230,225,0.9)]"
                    >
                      Sign in
                    </Link>
                  )}
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-full border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.04)] px-3 py-2 text-sm font-medium text-[rgba(232,230,225,0.7)] md:hidden"
        >
          <span className="flex flex-col gap-[3.5px]">
      ...
      {/* ── Mobile Menu ───────────────────────────────────────────────── */}
      {mobileOpen && (
        <div className="animate-nav-drop border-t border-[rgba(255,255,255,0.06)] bg-[rgba(13,13,15,0.97)] px-4 py-3 backdrop-blur-2xl md:hidden">
          <div className="flex flex-col gap-0.5">
            ...
            <div className="my-2 h-px bg-[rgba(255,255,255,0.06)]" />
            {user
              ? <button onClick={() => signOut()} className="rounded-full px-3.5 py-2 text-left text-[13px] font-medium text-[rgba(239,68,68,0.8)]">Sign out</button>
